import { w as watch, d as defineComponent, t as toRefs, r as ref, o as onMounted, a as onBeforeUnmount, b as onActivated, e as onDeactivated, h as h$2, n as nextTick } from './vendor/vue-DtCupTCT.js';
...
const I$2 = Ee.bind(window, !1), X = Ee.bind(window, !0);
function ne(n) {
...
function qe(n, ...e) {
  ...
  if (R$2(n) && R$2(t))
    for (const o in t)
      R$2(t[o]) ? (n[o] || Object.assign(n, { [o]: {} }), qe(n[o], t[o])) : Object.assign(n, { [o]: t[o] });
  return qe(n, ...e);
}
function et(n) {
  const e = Co();
...
function At(n) {
  n.dataset.empty = d$3.isEmpty(n) ? "true" : "false";
}
const No = {
  blockTunes: {
    toggler: {
...
let b$1 = class b {
  ...
  static get anchorElement() {
    ...
    return t ? d$3.isElement(t) ? t : t.parentElement : null;
  }
  /**
  ...
  static setCursor(e, t = 0) {
    ...
    return d$3.isNativeInput(e) ? d$3.canSetCaret(e) ? (e.focus(), e.selectionStart = e.selectionEnd = t, e.getBoundingClientRect()) : void 0 : (o.setStart(e, t), o.setEnd(e, t), i.removeAllRanges(), i.addRange(o), o.getBoundingClientRect());
  }
  /**
  ...
  static addFakeCursor() {
    ...
    if (e === null)
      return;
    const t = d$3.make("span", "codex-editor__fake-cursor");
  ...
  static isFakeCursorInsideContainer(e) {
    return d$3.find(e, ".codex-editor__fake-cursor") !== null;
  }
  /**
  ...
  static removeFakeCursor(e = document.body) {
    const t = d$3.find(e, ".codex-editor__fake-cursor");
    t && t.remove();
  }
  /**
...
function Ho(n, e) {
  ...
  return A$1(t) ? t(n) : Q(t) ? n[t] : (t !== void 0 && I$2("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function wt(n, e) {
  const t = e == null ? void 0 : e.import;
  return A$1(t) ? t(n) : Q(t) ? {
    [t]: n
...
const Ut = class ke {
  ...
  leafNodesAndReturnIndex(e) {
    if (this.items.length === 0)
      return this.cursor;
    let t = this.cursor;
    return t === -1 ? t = e === ke.directions.RIGHT ? -1 : 0 : this.items[t].classList.remove(this.focusedCssClass), e === ke.directions.RIGHT ? t = (t + 1) % this.items.length : t = (this.items.length + t - 1) % this.items.length, d$3.canSetCaret(this.items[t]) && Oe(() => b$1.setCursor(this.items[t]), 50)(), this.items[t].classList.add(this.focusedCssClass), t;
  }
};
Ut.directions = {
  RIGHT: "right",
...
class re {
   ...
   */
  handleEnterPress(e) {
    this.activated && (this.iterator.currentItem && (e.stopPropagation(), e.preventDefault(), this.iterator.currentItem.click()), A$1(this.activateCallback) && this.activateCallback(this.iterator.currentItem));
  }
  /**
...
class ni {
  ...
  constructor(e) {
    this.nodes = {
      root: d$3.make("div", [be.root, e.alignment === "center" ? be.alignedCenter : be.alignedStart]),
      title: d$3.make("div", be.title, { textContent: e.title })
    }, this.nodes.root.appendChild(this.nodes.title), e.description !== void 0 && (this.nodes.description = d$3.make("div", be.description, { textContent: e.description }), this.nodes.root.appendChild(this.nodes.description));
  }
  /**
...
const W = te("ce-popover-item"), L$2 = {
  container: W(),
...
class se extends ot {
  ...
  make(e, t) {
    var s, r;
    const o = (t == null ? void 0 : t.wrapperTag) || "div", i = d$3.make(o, L$2.container, {
      type: o === "button" ? "button" : void 0
    });
    return e.name && (i.dataset.itemName = e.name), this.nodes.icon = d$3.make("div", [L$2.icon, L$2.iconTool], {
      innerHTML: e.icon || Ko
    }), i.appendChild(this.nodes.icon), e.title !== void 0 && i.appendChild(d$3.make("div", L$2.title, {
      innerHTML: e.title || ""
    })), e.secondaryLabel && i.appendChild(d$3.make("div", L$2.secondaryTitle, {
      textContent: e.secondaryLabel
    })), this.hasChildren && i.appendChild(d$3.make("div", [L$2.icon, L$2.iconChevronRight], {
      innerHTML: $o
...
class Yt extends ot {
  ...
  constructor() {
    super(), this.nodes = {
      root: d$3.make("div", je.container),
      line: d$3.make("div", je.line)
...
var O$2 = /* @__PURE__ */ ((n) => (n.Default = "default", n.Separator = "separator", n.Html = "html", n))(O$2 || {}), Z = /* @__PURE__ */ ((n) => (n.Closed = "closed", n.ClosedOnActivate = "closed-on-activate", n))(Z || {});
const H$2 = te("ce-popover"), N = {
  popover: H$2(),
...
class Wt extends Be {
  ...
  constructor(e, t = {}) {
    super(), this.params = e, this.itemsRenderParams = t, this.listeners = new Te(), this.messages = {
      ...
      ...this.messages,
      ...e.messages
    }), this.nodes = {}, this.nodes.popoverContainer = d$3.make("div", [N.popoverContainer]), this.nodes.nothingFoundMessage = d$3.make("div", [N.nothingFoundMessage], {
      textContent: this.messages.nothingFound
    }), this.nodes.popoverContainer.appendChild(this.nodes.nothingFoundMessage), this.nodes.items = d$3.make("div", [N.items]), this.items.forEach((o) => {
      const i = o.getElement();
      i !== null && this.nodes.items.appendChild(i);
    }), this.nodes.popoverContainer.appendChild(this.nodes.items), this.listeners.on(this.nodes.popoverContainer, "click", (o) => this.handleClick(o)), this.nodes.popover = d$3.make("div", [
      N.popover,
      this.params.class
    ...
    return e.map((t) => {
      switch (t.type) {
        case O$2.Separator:
          return new Yt();
        case O$2.Html:
          return new ye(t, this.itemsRenderParams[O$2.Html]);
        default:
          return new se(t, this.itemsRenderParams[O$2.Default]);
      }
    });
  }
  /**
...
class ri extends Be {
  ...
  constructor({ items: e, placeholder: t }) {
    super(), this.listeners = new Te(), this.items = e, this.wrapper = d$3.make("div", Ye.wrapper);
    const o = d$3.make("div", Ye.icon, {
      innerHTML: Zo
    });
    this.input = d$3.make("input", Ye.input, {
      placeholder: t,
      /**
...
class ui {
  ...
  constructor({ text: e, onBackButtonClick: t }) {
    this.listeners = new Te(), this.text = e, this.onBackButtonClick = t, this.nodes = {
      root: d$3.make("div", [Ke.root]),
      backButton: d$3.make("button", [Ke.backButton]),
      text: d$3.make("div", [Ke.text])
...
class qt extends Wt {
  ...
  constructor(e) {
    ...
    }), this.scrollLocker = new hi(), this.history = new pi(), this.isHidden = !0, this.nodes.overlay = d$3.make("div", [N.overlay, N.overlayHidden]), this.nodes.popover.insertBefore(this.nodes.overlay, this.nodes.popover.firstChild), this.listeners.on(this.nodes.overlay, "click", () => {
      this.hide();
...
let D$1 = class D extends Be {
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      a || c ? u = !0 : u = !(l.length > 0 && l.every((p) => {
        ...
        return [
          ...
          ...Array.from(f),
          k
        ].some((S) => (d$3.isElement(S) || (S = S.parentElement), S && S.closest('[data-mutation-free="true"]') !== null));
  ...
  get inputs() {
    ...
    const e = d$3.findAllInputs(this.holder);
   ...
   */
  get mergeable() {
    return A$1(this.toolInstance.merge);
  }
  /**
   ...
   */
  get isEmpty() {
    const e = d$3.isEmpty(this.pluginsContent, "/"), t = !this.hasMedia;
    return e && t;
  }
  /**
  ...
  set selected(e) {
    ...
    (t || o) && ((i = this.editorEventBus) == null || i.emit(Dt, { state: e }), t ? b$1.addFakeCursor() : b$1.removeFakeCursor(this.holder), (s = this.editorEventBus) == null || s.emit(Rt, { state: e }));
  }
  /**
   ...
   */
  updateCurrentInput() {
    this.currentInput = d$3.isNativeInput(document.activeElement) || !b$1.anchorNode ? document.activeElement : b$1.anchorNode;
  }
  /**
   * Allows to say Editor that Block was changed. Used to manually trigger Editor's 'onChange' callback
   * Can be useful for block changes invisible for editor core.
   ...
   */
  destroy() {
    this.unwatchBlockMutations(), this.removeInputEvents(), super.destroy(), A$1(this.toolInstance.destroy) && this.toolInstance.destroy();
  }
  /**
   * Tool could specify several entries to be displayed at the Toolbox (for example, "Heading 1", "Heading 2", "Heading 3")
   * This method returns the entry that is related to the Block (depended on the Block data)
   ...
   */
  compose() {
    const e = d$3.make("div", D.CSS.wrapper), t = d$3.make("div", D.CSS.content), o = this.toolInstance.render();
  ...
  addInputEvents() {
    this.inputs.forEach((e) => {
      e.addEventListener("focus", this.handleFocus), d$3.isNativeInput(e) && e.addEventListener("input", this.didMutated);
    });
  }
  /**
  ...
  removeInputEvents() {
    this.inputs.forEach((e) => {
      e.removeEventListener("focus", this.handleFocus), d$3.isNativeInput(e) && e.removeEventListener("input", this.didMutated);
    });
  }
  /**
...
function rt(n, e) {
  return Array.isArray(n) ? Ii(n, e) : R$2(n) ? Mi(n, e) : Q(n) ? Oi(n, e) : n;
}
function Ii(n, e) {
...
function Oi(n, e) {
  return R$2(e) ? q$1(n, e) : e === !1 ? q$1(n, {}) : n;
}
function Ai(n) {
  return R$2(n) || yo(n) || A$1(n);
}
...
class Ui extends y$1 {
   ...
   */
  make() {
    this.nodes.wrapper = d$3.make("div", [this.CSS.settings]), this.eventsDispatcher.on(xe, this.close);
  }
  /**
   * Destroys module
   */
  ...
  resolveTuneAliases(e) {
    if (e.type === O$2.Separator || e.type === O$2.Html)
      return e;
...
const lt = class to extends Be {
  ...
  constructor({ api: e, tools: t, i18nLabels: o }) {
    super(), this.opened = !1, this.listeners = new Te(), this.popover = null, this.handleMobileLayoutToggle = () => {
      ...
      toolbox: d$3.make("div", to.CSS.toolbox)
...
class qi extends y$1 {
   ...
   */
  async make() {
    this.nodes.wrapper = d$3.make("div", this.CSS.toolbar), ["content", "actions"].forEach((s) => {
      this.nodes[s] = d$3.make("div", this.CSS[s]);
    }), d$3.append(this.nodes.wrapper, this.nodes.content), d$3.append(this.nodes.content, this.nodes.actions), this.nodes.plusButton = d$3.make("div", this.CSS.plusButton, {
      innerHTML: qo
    }), d$3.append(this.nodes.actions, this.nodes.plusButton), this.readOnlyMutableListeners.on(this.nodes.plusButton, "click", () => {
      _e(!0), this.plusButtonClicked();
    }, !1);
    const e = d$3.make("div");
    e.appendChild(document.createTextNode(z.ui(K.ui.toolbar.toolbox, "Add"))), e.appendChild(d$3.make("div", this.CSS.plusButtonShortcut, {
      textContent: "/"
    })), Ne(this.nodes.plusButton, e, {
      hidingDelay: 400
    }), this.nodes.settingsToggler = d$3.make("span", this.CSS.settingsToggler, {
      innerHTML: Vo
    }), d$3.append(this.nodes.actions, this.nodes.settingsToggler);
    const t = d$3.make("div"), o = d$3.text(z.ui(K.ui.blockTunes.toggler, "Click to tune")), i = await Vi("Slash", "/");
    t.appendChild(o), t.appendChild(d$3.make("div", this.CSS.plusButtonShortcut, {
      textContent: et(`CMD + ${i}`)
    })), Ne(this.nodes.settingsToggler, t, {
      hidingDelay: 400
    }), d$3.append(this.nodes.actions, this.makeToolbox()), d$3.append(this.nodes.actions, this.Editor.BlockSettings.getElement()), d$3.append(this.Editor.UI.nodes.wrapper, this.nodes.wrapper);
  }
  /**
...
class ct {
   ...
   */
  reset() {
    if (A$1(this.constructable.reset))
   ...
   */
  prepare() {
    if (A$1(this.constructable.prepare))
...
class Zi extends y$1 {
  ...
  close() {
    ...
    this.opened && (this.Editor.ReadOnly.isEnabled || (Array.from(this.toolsInstances.entries()).forEach(([o, i]) => {
      ...
      s && de.remove(this.Editor.UI.nodes.redactor, s), A$1(i.clear) && i.clear();
   ...
   */
  make() {
    this.nodes.wrapper = d$3.make("div", [
      this.CSS.inlineToolbar,
      ...this.isRtl ? [this.Editor.UI.CSS.editorRtlFix] : []
    ]), d$3.append(this.Editor.UI.nodes.wrapper, this.nodes.wrapper);
  }
  /**
  ...
  allowedToShow() {
    ...
    if (!t || !t.anchorNode || t.isCollapsed || o.length < 1)
      return !1;
    const i = d$3.isElement(t.anchorNode) ? t.anchorNode : t.anchorNode.parentElement;
    ...
    for (let s = 0; s < o.length; s++) {
      ...
      [a].flat().forEach((p) => {
        ...
        if (d$3.isElement(p)) {
          ...
          i.push(C);
        } else if (p.type === O$2.Html)
          i.push({
            ...g,
            ...p,
            type: O$2.Html
          });
        else if (p.type === O$2.Separator)
          i.push({
            type: O$2.Separator
          });
        else {
...
function Ie(n) {
  const e = d$3.getDeepestNode(n);
  if (e === null || d$3.isEmpty(n))
    return !0;
  if (d$3.isNativeInput(e))
...
function Me(n) {
  const e = d$3.getDeepestNode(n, !0);
  if (e === null)
    return !0;
  if (d$3.isNativeInput(e))
...
class Gi extends y$1 {
  ...
  backspace(e) {
    ...
    if (i === void 0 || !b$1.isCollapsed || !i.currentInput || !Ie(i.currentInput))
      return;
  ...
  delete(e) {
    ...
    if (!b$1.isCollapsed || !Me(i.currentInput))
      return;
...
class Xe {
  ...
  swap(e, t) {
    ...
    d$3.swap(this.blocks[e].holder, o.holder), this.blocks[t] = this.blocks[e], this.blocks[e] = o;
  }
  /**
...
class es extends y$1 {
   ...
   */
  split() {
    const e = this.Editor.Caret.extractFragmentFromCaretPosition(), t = d$3.make("div");
    t.appendChild(e);
    const o = {
      text: d$3.isEmpty(t) ? "" : t.innerHTML
    };
   ...
   */
  getBlock(e) {
    d$3.isElement(e) || (e = e.parentNode);
...
class ts extends y$1 {
  ...
  copySelectedBlocks(e) {
    e.preventDefault();
    const t = d$3.make("div");
    this.selectedBlocks.forEach((s) => {
      const r = q$1(s.holder.innerHTML, this.sanitizerConfig), l = d$3.make("p");
...
`), i = t.innerHTML;
   ...
   */
  handleCommandA(e) {
    if (this.Editor.RectangleSelection.clearSelection(), d$3.isNativeInput(e.target) && !this.readyToBlockSelection) {
...
class De extends y$1 {
  ...
  setToBlock(e, t = this.positions.DEFAULT, o = 0) {
    ...
    if (!r)
      return;
    const l = d$3.getDeepestNode(r, t === this.positions.END), a = d$3.getContentLength(l);
    switch (!0) {
  ...
  setToInput(e, t = this.positions.DEFAULT, o = 0) {
    const { currentBlock: i } = this.Editor.BlockManager, s = d$3.getDeepestNode(e);
    switch (t) {
      case this.positions.START:
        this.set(s, 0);
        break;
      case this.positions.END:
        this.set(s, d$3.getContentLength(s));
        break;
      default:
        o && this.set(s, o);
    }
...
class rs extends y$1 {
  ...
  particularBlockChanged(e) {
    this.disabled || !A$1(this.config.onChange) || (this.batchingOnChangeQueue.set(`block:${e.detail.target.id}:event:${e.type}`, e), this.batchingTimeout && clearTimeout(this.batchingTimeout), this.batchingTimeout = setTimeout(() => {
      let t;
...
const ro = class lo extends y$1 {
  ...
  async processDataTransfer(e, t = !1) {
    ...
    !h.trim() || h.trim() === l || !d$3.isHTMLString(h) ? await this.processText(l) : await this.processText(h, !0);
  }
  /**
   ...
   */
  collectTagNames(e) {
    return Q(e) ? [e] : R$2(e) ? Object.keys(e) : [];
  }
  /**
  ...
  processHTML(e) {
    ...
    return o.innerHTML = e, this.getNodes(o).map((s) => {
      ...
      const r = d$3.isEmpty(s.content), l = d$3.isSingleTag(s.content);
      return !r || l;
    });
  }
  /**
  ...
  async processSingleBlock(e) {
    ...
    if (!i || e.tool !== i.name || !d$3.containsOnlyInlineElements(e.content.innerHTML)) {
  ...
  processElementNode(e, t, o) {
    const i = Object.keys(this.toolsTags), s = e, { tool: r } = this.toolsTags[s.tagName] || {}, l = this.tagsByTool[r == null ? void 0 : r.name] || [], a = i.includes(s.tagName), c = d$3.blockElements.includes(s.tagName.toLowerCase()), u = Array.from(s.children).some(
      ({ tagName: p }) => i.includes(p) && !l.includes(p)
    ), h = Array.from(s.children).some(
      ({ tagName: p }) => d$3.blockElements.includes(p.toLowerCase())
    );
    if (!c && !a && !u)
  ...
  getNodes(e) {
    ...
    let o;
    const i = (s, r) => {
      if (d$3.isEmpty(r) && !d$3.isSingleTag(r))
        return s;
      const l = s[s.length - 1];
      let a = new DocumentFragment();
      switch (l && d$3.isFragment(l) && (a = s.pop()), r.nodeType) {
        case Node.ELEMENT_NODE:
...
class we extends y$1 {
  ...
  processMouseDown(e) {
    if (e.button !== this.MAIN_MOUSE_BUTTON)
      return;
    e.target.closest(d$3.allInputsSelector) !== null || this.startSelection(e.pageX, e.pageY);
  }
  /**
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = d$3.make("div", we.CSS.overlay, {}), i = d$3.make("div", we.CSS.overlayContainer, {}), s = d$3.make("div", we.CSS.rect, {});
...
class co {
   ...
   */
  make() {
    const e = d$3.make("div", this.CSS.wrapper), t = Jo, o = d$3.make("div", this.CSS.info), i = d$3.make("div", this.CSS.title, {
      textContent: this.title
    }), s = d$3.make("div", this.CSS.subtitle, {
  ...
  getListOfPrepareFunctions(e) {
    ...
    return Object.entries(e).forEach(([o, i]) => {
      t.push({
        ...
        function: A$1(i.class.prepare) ? i.class.prepare : () => {
        },
        data: {
          toolName: o,
          config: i.config
...
class ys extends y$1 {
   ...
   */
  make() {
    this.nodes.holder = d$3.getHolder(this.config.holder), this.nodes.wrapper = d$3.make("div", [
      this.CSS.editorWrapper,
      ...this.isRtl ? [this.CSS.editorRtlFix] : []
    ]), this.nodes.redactor = d$3.make("div", this.CSS.editorZone), this.nodes.holder.offsetWidth < this.contentRect.width && this.nodes.wrapper.classList.add(this.CSS.editorWrapperNarrow), this.nodes.redactor.style.paddingBottom = this.config.minHeight + "px", this.nodes.wrapper.appendChild(this.nodes.redactor), this.nodes.holder.appendChild(this.nodes.wrapper);
  }
  /**
   * Appends CSS
   */
  loadStyles() {
    ...
    if (d$3.get(e))
      return;
    const t = d$3.make("style", null, {
      id: e,
      textContent: xs.toString()
    });
    this.config.style && !V(this.config.style) && this.config.style.nonce && t.setAttribute("nonce", this.config.style.nonce), d$3.prepend(document.head, t);
  }
  /**
  ...
  processBottomZoneClick(e) {
    const t = this.Editor.BlockManager.getBlockByIndex(-1), o = d$3.offset(t.holder).bottom, i = e.pageY, { BlockSelection: s } = this.Editor;
...
class Ts {
  ...
  constructor(e) {
    ...
    R$2(e) && A$1(e.onReady) && (t = e.onReady);
    const o = new Bs(e);
  ...
  exportAPI(e) {
    const t = ["configuration"], o = () => {
      Object.values(e.moduleInstances).forEach((s) => {
        A$1(s.destroy) && s.destroy(), s.listeners.removeAll();
      }), oi(), e = null;
      for (const s in this)
...
let x$1 = class x {
  ...
  constructor({ api: a, config: r, onSelectFile: c, readOnly: i }) {
    this.api = a, this.config = r, this.onSelectFile = c, this.readOnly = i, this.nodes = {
      wrapper: S$1("div", [this.CSS.baseClass, this.CSS.wrapper]),
      imageContainer: S$1("div", [this.CSS.imageContainer]),
      fileButton: this.createFileButton(),
      imageEl: void 0,
      imagePreloader: S$1("div", this.CSS.imagePreloader),
      caption: S$1("div", [this.CSS.input, this.CSS.caption], {
   ...
   */
  createFileButton() {
    const a = S$1("div", [this.CSS.button]);
    return a.innerHTML = this.config.buttonContent || `${L$1} ${this.api.i18n.t("Select an Image")}`, a.addEventListener("click", () => {
      this.onSelectFile();
    }), a;
  }
  /**
  ...
  fillImage(a) {
    ...
    let i = "load";
    r === "VIDEO" && (c.autoplay = !0, c.loop = !0, c.muted = !0, c.playsinline = !0, i = "loadeddata"), this.nodes.imageEl = S$1(r, this.CSS.imageEl, c), this.nodes.imageEl.addEventListener(i, () => {
      this.toggleStatus(
        "filled"
        /* Filled */
...
class q {
  ...
  uploadSelectedFile({ onPreview: a }) {
    ...
    if (this.config.uploader && typeof this.config.uploader.uploadByFile == "function") {
      ...
      c = _.selectFiles({ accept: this.config.types || "image/*" }).then((o) => {
        r(o[0]);
        const n = i(o[0]);
        return O$1(n) || console.warn("Custom uploader method uploadByFile should return a Promise"), n;
      });
    } else
      c = _.transport({
  ...
  uploadByUrl(a) {
    let r;
    this.config.uploader && typeof this.config.uploader.uploadByUrl == "function" ? (r = this.config.uploader.uploadByUrl(a), O$1(r) || console.warn("Custom uploader method uploadByUrl should return a Promise")) : r = _.post({
  ...
  uploadByFile(a, { onPreview: r }) {
    ...
    let i;
    if (this.config.uploader && typeof this.config.uploader.uploadByFile == "function")
      i = this.config.uploader.uploadByFile(a), O$1(i) || console.warn("Custom uploader method uploadByFile should return a Promise");
    else {
...
export { Editor as E, I, P, Ts as T, d as a, c$1 as c, d$1 as d };
