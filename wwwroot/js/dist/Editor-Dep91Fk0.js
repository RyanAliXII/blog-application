...
const Ut = class ke {
  ...
  leafNodesAndReturnIndex(e) {
    if (this.items.length === 0)
      return this.cursor;
    let t = this.cursor;
    return t === -1 ? t = e === ke.directions.RIGHT ? -1 : 0 : this.items[t].classList.remove(this.focusedCssClass), e === ke.directions.RIGHT ? t = (t + 1) % this.items.length : t = (this.items.length + t - 1) % this.items.length, d$3.canSetCaret(this.items[t]) && Oe(() => b.setCursor(this.items[t]), 50)(), this.items[t].classList.add(this.focusedCssClass), t;
  }
};
Ut.directions = {
  RIGHT: "right",
...
class se extends ot {
  ...
  make(e, t) {
    var s, r;
    const o = (t == null ? void 0 : t.wrapperTag) || "div", i = d$3.make(o, L$1.container, {
      type: o === "button" ? "button" : void 0
    });
    return e.name && (i.dataset.itemName = e.name), this.nodes.icon = d$3.make("div", [L$1.icon, L$1.iconTool], {
      innerHTML: e.icon || Ko
    }), i.appendChild(this.nodes.icon), e.title !== void 0 && i.appendChild(d$3.make("div", L$1.title, {
      innerHTML: e.title || ""
    })), e.secondaryLabel && i.appendChild(d$3.make("div", L$1.secondaryTitle, {
      textContent: e.secondaryLabel
    })), this.hasChildren && i.appendChild(d$3.make("div", [L$1.icon, L$1.iconChevronRight], {
      innerHTML: $o
...
let D$1 = class D extends Be {
   ...
   */
  updateCurrentInput() {
    this.currentInput = d$3.isNativeInput(document.activeElement) || !b.anchorNode ? document.activeElement : b.anchorNode;
  }
  /**
   * Allows to say Editor that Block was changed. Used to manually trigger Editor's 'onChange' callback
   * Can be useful for block changes invisible for editor core.
...
export { Editor as E, P, Ts as T, d as a, c, d$1 as d };
