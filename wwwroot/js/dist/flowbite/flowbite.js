...
var Accordion = /** @class */ (function () {
    function Accordion(accordionEl, items, options, instanceOptions) {
        ...
        if (options === void 0) { options = Default$d; }
        if (instanceOptions === void 0) { instanceOptions = DefaultInstanceOptions$d; }
    ...
    document.querySelectorAll('[data-accordion]').forEach(function ($accordionEl) {
        ...
        new Accordion($accordionEl, items, {
            ...
            activeClasses: activeClasses
                ? activeClasses
                : Default$d.activeClasses,
            inactiveClasses: inactiveClasses
                ? inactiveClasses
                : Default$d.inactiveClasses,
        });
    });
}
if (typeof window !== 'undefined') {
...
var Collapse = /** @class */ (function () {
    function Collapse(targetEl, triggerEl, options, instanceOptions) {
        ...
        if (options === void 0) { options = Default$c; }
        if (instanceOptions === void 0) { instanceOptions = DefaultInstanceOptions$c; }
        this._instanceId = instanceOptions.id
            ? instanceOptions.id
            : targetEl.id;
...
var Dropdown = /** @class */ (function () {
    ...
    Dropdown.prototype.show = function () {
        ...
        this._popperInstance.setOptions(function (options) { return (__assign$9(__assign$9({}, options), { modifiers: __spreadArray$2(__spreadArray$2([], options.modifiers, true), [
        ...
        if ($dropdownEl) {
            ...
            new Dropdown($dropdownEl, $triggerEl, {
                ...
                triggerType: triggerType
                    ? triggerType
                    : Default$9.triggerType,
                offsetSkidding: offsetSkidding
                    ? parseInt(offsetSkidding)
                    : Default$9.offsetSkidding,
                offsetDistance: offsetDistance
                    ? parseInt(offsetDistance)
                    : Default$9.offsetDistance,
...
function initTabs() {
    document.querySelectorAll('[data-tabs-toggle]').forEach(function ($parentEl) {
        ...
        new Tabs($parentEl, tabItems, {
            ...
            activeClasses: activeClasses
                ? activeClasses
                : Default$6.activeClasses,
            inactiveClasses: inactiveClasses
                ? inactiveClasses
                : Default$6.inactiveClasses,
        });
    });
}
if (typeof window !== 'undefined') {
...
var Tooltip = /** @class */ (function () {
    ...
    Tooltip.prototype.show = function () {
        ...
        // Enable the event listeners
        this._popperInstance.setOptions(function (options) { return (__assign$5(__assign$5({}, options), { modifiers: __spreadArray$1(__spreadArray$1([], options.modifiers, true), [
                { name: 'eventListeners', enabled: true },
            ], false) })); });
...
var Popover = /** @class */ (function () {
    ...
    Popover.prototype.show = function () {
        ...
        this._targetEl.classList.add('opacity-100', 'visible');
        // Enable the event listeners
        this._popperInstance.setOptions(function (options) { return (__assign$4(__assign$4({}, options), { modifiers: __spreadArray(__spreadArray([], options.modifiers, true), [
                { name: 'eventListeners', enabled: true },
            ], false) })); });
        // handle click outside
        this._setupClickOutsideListener();
            ...
            if (!instances.instanceExists('CopyClipboard', $targetEl.getAttribute('id'))) {
                new CopyClipboard($triggerEl, $targetEl, {
                    htmlEntities: htmlEntities && htmlEntities === 'true'
                        ? true
                        : Default$1.htmlEntities,
                    contentType: contentType
                        ? contentType
                        : Default$1.contentType,
                });
            }
        }
        else {
...
var Datepicker = /** @class */ (function () {
    ...
    Datepicker.prototype.getDate = function () {
        ...
        if (!this._options.rangePicker &&
            this._datepickerInstance instanceof Datepicker$1) {
