...
var plugins = {
    image: function (block) {
        if (block.data.stretched) {
            return "<img src=\"".concat(block.data.file.url, "\" class=\"w-full h-auto\" alt=\"").concat(block.data.caption, "\">");
        }
        else {
            return "<img src=\"".concat(block.data.file.url, "\" alt=\"").concat(block.data.caption, "\" >");
        }
    },
    table: function (block) {
        var _a, _b;
        var markup = "<table class=\"w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400\">";
        var data = block.data;
        var startIdx = 0;
        if (data.withHeadings) {
            var thead_1 = "<thead class=\"text-xs  text-gray-700  bg-gray-50 dark:bg-gray-700 dark:text-gray-400\">\n          <tr>\n      ";
            var firstRow = (_b = (_a = data.content) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : [];
            firstRow.forEach(function (cell) {
                thead_1 += "<th scope=\"col\" class=\"px-6 py-3\">\n                    ".concat(cell, "\n                  </th>");
            });
            startIdx = 1;
            thead_1 += "</tr></thead>";
            markup += thead_1;
        ...
        var tbody = "<tbody>";
        for (var i = startIdx; i < data.content.length; i++) {
...
var editorParser = edjsParser(plugins);
createApp({
    setup: function () {
        var data = ref({
            title: "",
        ...
        onMounted(function () {
            ...
            data.value.title = (_c = (_b = (_a = window.viewData) === null || _a === void 0 ? void 0 : _a.post) === null || _b === void 0 ? void 0 : _b.title) !== null && _c !== void 0 ? _c : "";
            data.value.content = (_f = (_e = (_d = window.viewData) === null || _d === void 0 ? void 0 : _d.post) === null || _e === void 0 ? void 0 : _e.content) !== null && _f !== void 0 ? _f : [];
            var htmlBlocks = editorParser.parse({
                blocks: data.value.content,
            });
            var html = htmlBlocks.reduce(function (a, b) {
                a += b;
                return a;
            }, "");
            html = purify.sanitize(html);
            data.value.contentHtml = html;
            var date = new Date((_h = (_g = window.viewData) === null || _g === void 0 ? void 0 : _g.post) === null || _h === void 0 ? void 0 : _h.createdAt);
