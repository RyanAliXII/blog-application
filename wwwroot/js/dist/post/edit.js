...
import { E as Editor, T as Ts, c, d, I, P, a as d$1 } from '../Editor-5fdTFU1X.js';
    ...
    setup: function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, fetch("/App/Post/Edit/".concat(form.value.id), {
                                method: "PUT",
                                headers: new Headers({
        ...
        onMounted(function () {
            ...
            editor.isReady.then(function () {
                ...
                editor.render({
                    time: Date.now(),
                    blocks: (_c = (_b = (_a = window.viewData) === null || _a === void 0 ? void 0 : _a.post) === null || _b === void 0 ? void 0 : _b.content) !== null && _c !== void 0 ? _c : [],
                    version: Ts.version,
                });
            });
            form.value.title = (_c = (_b = (_a = window.viewData) === null || _a === void 0 ? void 0 : _a.post) === null || _b === void 0 ? void 0 : _b.title) !== null && _c !== void 0 ? _c : "";
            form.value.id = (_f = (_e = (_d = window.viewData) === null || _d === void 0 ? void 0 : _d.post) === null || _e === void 0 ? void 0 : _e.id) !== null && _f !== void 0 ? _f : "";
        });
        return {
            editorRef: editorRef,
